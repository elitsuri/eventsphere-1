...
Event management with ticketing, RSVPs, and live streaming integration
"""
...
app = FastAPI(
    title="EventSphere",
    description="Event management with ticketing, RSVPs, and live streaming integration",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "EventSphere"}
